...
public class NotifyService {
    ...
    public static void sendConfirmationEmail(final String emailAddress, final String exportBatchId,
        ...
        RestService.sendPostRequest(sendLambdaExportEmailDTO, "/emails/sendLambdaConfirmationEmail");
