...
public class TestData {
    ...
    public static final SubmissionQuestion V1_ORG_TYPE_SUBMISSION_QUESTION = SubmissionQuestion.builder()
            ...
            .response("V1_Limited company").build();
    ...
    public static final SubmissionQuestion V1_ORG_NAME_SUBMISSION_QUESTION = SubmissionQuestion.builder()
            ...
            .response("V1_Company name").build();
    ...
    public static final SubmissionQuestion V1_ORG_ADDRESS_SUBMISSION_QUESTION = SubmissionQuestion.builder()
            ...
            .multiResponse(new String[]{"V1_9-10 St Andrew Square", "", "V1_Edinburgh", "", "V1_EH2 2AF"}).build();
    ...
    public static final SubmissionQuestion V1_ORG_COMPANIES_NO_SUBMISSION_QUESTION = SubmissionQuestion.builder()
            ...
            .responseType(ResponseTypeEnum.ShortAnswer)
            .validation(SubmissionQuestionValidation.builder().mandatory(true).build()).response("V1_CHN").build();
    ...
    public static final SubmissionQuestion V1_ORG_CHARITY_NO_SUBMISSION_QUESTION = SubmissionQuestion.builder()
            ...
            .hintText(
                    "Funding organisation might use this to identify your organisation when you apply for a grant. It might also be used to check your organisation is legitimate.")
            .responseType(ResponseTypeEnum.ShortAnswer)
            .validation(SubmissionQuestionValidation.builder().mandatory(true).build()).response("V1_12738494").build();
    ...
    public static final SubmissionQuestion V1_ORG_BENEFICIARY_LOC_SUBMISSION_QUESTION = SubmissionQuestion.builder()
            ...
            .multiResponse(new String[]{"V1_Scotland", "V1_North East England"}).build();

    public static final SubmissionQuestion V2_ORG_TYPE_SUBMISSION_QUESTION = SubmissionQuestion.builder()
            .questionId("APPLICANT_TYPE").fieldTitle("Choose your organisation type").profileField("ORG_TYPE")
            .hintText("Choose the option that best describes your organisation").responseType(ResponseTypeEnum.Dropdown)
            .validation(SubmissionQuestionValidation.builder().mandatory(true).build()).options(new String[]{
                    "Limited company", "Non-limited company", "Registered charity", "Unregistered charity", "Other"})
            .response("V2_Limited company").build();
    ...
    public static final SubmissionQuestion V2_ORG_NAME_SUBMISSION_QUESTION = SubmissionQuestion.builder()
            ...
            .responseType(ResponseTypeEnum.ShortAnswer)
            .validation(SubmissionQuestionValidation.builder().mandatory(true).minLength(5).maxLength(100).build())
            .response("V2_Company name").build();
    ...
    public static final SubmissionQuestion V2_ORG_ADDRESS_SUBMISSION_QUESTION = SubmissionQuestion.builder()
            ...
            .fieldTitle("Enter your organisation's address").responseType(ResponseTypeEnum.AddressInput)
            .validation(SubmissionQuestionValidation.builder().mandatory(true).build())
            .multiResponse(new String[]{"V2_9-10 St Andrew Square", "", "V2_Edinburgh", "", "V2_EH2 2AF"}).build();
    ...
    public static final SubmissionQuestion V2_ORG_COMPANIES_NO_SUBMISSION_QUESTION = SubmissionQuestion.builder()
            ...
            .hintText(
                    "Funding organisation might use this to identify your organisation when you apply for a grant. It might also be used to check your organisation is legitimate.")
            .responseType(ResponseTypeEnum.ShortAnswer)
            .validation(SubmissionQuestionValidation.builder().mandatory(true).build()).response("V2_CHN").build();
    ...
    public static final SubmissionQuestion V2_ORG_CHARITY_NO_SUBMISSION_QUESTION = SubmissionQuestion.builder()
            ...
            .hintText(
                    "Funding organisation might use this to identify your organisation when you apply for a grant. It might also be used to check your organisation is legitimate.")
            .responseType(ResponseTypeEnum.ShortAnswer)
            .validation(SubmissionQuestionValidation.builder().mandatory(true).build()).response("V2_12738494").build();
    ...
    public static final SubmissionQuestion V2_ORG_BENEFICIARY_LOC_SUBMISSION_QUESTION = SubmissionQuestion.builder()
            ...
            .options(new String[]{"North East England", "North West England", "South East England",
                    "South West England", "Midlands", "Scotland", "Wales", "Northern Ireland"})
            .multiResponse(new String[]{"V2_Scotland", "V2_North East England"}).build();
    ...
    public static final SubmissionSection ORGANISATION_DETAILS_SECTION_SUBMISSION = SubmissionSection.builder()
            .sectionId("ORGANISATION_DETAILS").sectionTitle("Your organisation")
            .sectionStatus(SubmissionSectionStatus.COMPLETED)
            .questions(Arrays.asList(V2_ORG_TYPE_SUBMISSION_QUESTION, V2_ORG_NAME_SUBMISSION_QUESTION,
                    V2_ORG_ADDRESS_SUBMISSION_QUESTION, V2_ORG_COMPANIES_NO_SUBMISSION_QUESTION, V2_ORG_CHARITY_NO_SUBMISSION_QUESTION))
            .build();

    public static final SubmissionSection FUNDING_DETAILS_SECTION_SUBMISSION = SubmissionSection.builder()
            .sectionId("FUNDING_DETAILS").sectionTitle("Funding")
            .sectionStatus(SubmissionSectionStatus.COMPLETED)
            .questions(Arrays.asList(V2_ORG_AMOUNT_SUBMISSION_QUESTION, V2_ORG_BENEFICIARY_LOC_SUBMISSION_QUESTION))
            .build();
    public static final List<SubmissionSection> V2_SUBMISSION_SECTIONS_LIST = Arrays.asList(ELIGIBILITY_SECTION_SUBMISSION,
            ORGANISATION_DETAILS_SECTION_SUBMISSION, FUNDING_DETAILS_SECTION_SUBMISSION);
    public static final Submission V2_SUBMISSION = Submission.builder().legalName("Test Org Name v2").schemeName("v2Scheme Name")
            .gapId("GAP-LL-20220927-00001").submittedDate(Instant.parse("2022-02-15T18:35:24.00Z")).sections(V2_SUBMISSION_SECTIONS_LIST).schemeVersion(2).build();
    public static final SubmissionSection V1_CUSTOM_SECTION_SUBMISSION = SubmissionSection.builder()
            ...
            .build();
    public static final List<SubmissionSection> V1_SUBMISSION_SECTIONS_LIST = Arrays.asList(ELIGIBILITY_SECTION_SUBMISSION,
            ESSENTIAL_SECTION_SUBMISSION, V1_CUSTOM_SECTION_SUBMISSION);
    public static final Submission V1_SUBMISSION = Submission.builder().legalName("Test Org Name").schemeName("Scheme Name")
            .gapId("GAP-LL-20220927-00001").submittedDate(Instant.parse("2022-02-15T18:35:24.00Z")).sections(V1_SUBMISSION_SECTIONS_LIST).schemeVersion(1).build();
