...
public class SubmissionTestData {
        ...
        public static final Submission V1_SUBMISSION_WITHOUT_SECTIONS = new Submission(SCHEME_ID, SCHEME_NAME,
                        LEGAL_NAME,
                        GAP_ID, null, SUBMITTED_DATE, null, EMAIL, 1, true);
        ...
        public static final List<SubmissionSection> ESSENTIAL_INFO_SECTION = Collections
                        .singletonList(new SubmissionSection("ESSENTIAL", "essential",
                                        SubmissionSectionStatus.NOT_STARTED,
                                        Collections.singletonList(
                                                        SubmissionQuestion.builder().questionId("APPLICANT_ORG_NAME")
        ...
        public static final Submission V1_SUBMISSION_WITH_ESSENTIAL_SECTION = new Submission(SCHEME_ID, SCHEME_NAME,
                        LEGAL_NAME, GAP_ID, null, SUBMITTED_DATE, ESSENTIAL_INFO_SECTION, EMAIL, 1, true);
